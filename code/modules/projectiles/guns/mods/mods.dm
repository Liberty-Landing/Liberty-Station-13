...
//Adds extra burns and toxin damage to 9mm rounds. Acquired through raiding Simulacrum machines or heavy PI investment.
/obj/item/gun_upgrade/mechanism/glass_widow
	...
	matter = list(MATERIAL_ALUMINIUM = 6, MATERIAL_INDSTEEL = 4, MATERIAL_TITANIUMRTC = 4)
	price_tag = 800
...
/obj/item/gun_upgrade/mechanism/simulacrum_master_catalyst
	...
	icon_state = "psionic_catalyst"
	matter = list(MATERIAL_TITANIUMRTC = 5, MATERIAL_INDSTEEL = 3, MATERIAL_DIAMOND = 10)
	price_tag = 4500
...
/obj/item/gun_upgrade/magwell/auto_eject/no_removal
	name = "PI \"Braker\" Magwell Autodrop System"
