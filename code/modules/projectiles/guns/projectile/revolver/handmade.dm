/obj/item/gun/projectile/revolver/handmade
	...
	max_shells = 6
	matter = list(MATERIAL_WOOD = 10, MATERIAL_ALUMINIUM = 15)
	...
	gun_parts = list(/obj/item/part/gun/frame/revolver_handmade = 1, /obj/item/part/gun/grip/wood = 1, /obj/item/part/gun/mechanism/revolver/aluminium = 1, /obj/item/part/gun/barrel/magnum/aluminium = 1)
...
/obj/item/part/gun/frame/revolver_handmade
	...
	mechanismvar = /obj/item/part/gun/mechanism/revolver/aluminium
