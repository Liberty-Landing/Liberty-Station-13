/obj/item/gun/projectile/revolver/little_comet
	...
	even solid aluminium walls despite its low caliber, the weapons value derived from said gravitonic modification being old tech from Simulacrum Robotics that can no longer be reproduced. Uses 9mm special rounds."
