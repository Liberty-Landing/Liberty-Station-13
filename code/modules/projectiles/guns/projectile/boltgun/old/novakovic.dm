/obj/item/gun/projectile/boltgun/sa
	...
	gun_parts = list(/obj/item/part/gun/frame/boltgun = 1, /obj/item/part/gun/grip/wood = 1, /obj/item/part/gun/mechanism/boltgun = 1, /obj/item/part/gun/barrel/lrifle/aluminium = 1)
...
/obj/item/gun/projectile/boltgun/sawn/sa
	...
	matter = list(MATERIAL_ALUMINIUM = 10, MATERIAL_WOOD = 4)
	saw_off = FALSE
	serial_type = "Hunt Inc."
	gun_parts = list(/obj/item/part/gun/grip/wood = 1, /obj/item/part/gun/mechanism/boltgun = 1, /obj/item/part/gun/barrel/lrifle/aluminium = 1)
