/obj/item/gun/projectile/boltgun/handmade
	...
	icon_state = "boltgun"
	item_state = "boltgun"
	matter = list(MATERIAL_ALUMINIUM = 10, MATERIAL_WOOD = 5)
	...
	serial_type = "INDEX"
	serial_shown = FALSE
	gun_parts = list(/obj/item/part/gun/frame/homemadebolt = 1, /obj/item/part/gun/grip/wood = 1, /obj/item/part/gun/mechanism/boltgun = 1, /obj/item/part/gun/barrel/lrifle/aluminium = 1)
...
/obj/item/part/gun/frame/homemadebolt
	...
	barrelvars = list(/obj/item/part/gun/barrel/srifle/aluminium, /obj/item/part/gun/barrel/clrifle/aluminium)	//Basically any rifle caliber fits them.
