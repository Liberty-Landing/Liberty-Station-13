/obj/item/gun/projectile/judiciary
	...
	desc = "A common Liberty Marshal issue pistol chambered in 9mm. This pistol appears to be the workhorse of Marshals, a near staple found in pictures on nearly any recruiting ad. \
