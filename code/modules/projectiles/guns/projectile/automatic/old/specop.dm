/obj/item/gun/projectile/automatic/specop
	...
	desc = "The aptly named \"Spec Op\" is a 7mm hard hitting, compact SMG perfect for operators preferring stealth. While limited in range, operators remark the weapon as nearly silent, leaving behind no signs of a fight besides targets riddled with lead."
	icon_state = "specop"
	item_state = "specop"
