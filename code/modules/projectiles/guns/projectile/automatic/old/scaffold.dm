/obj/item/gun/projectile/automatic/scaffold
	name = "Simulacrum Robotics \"Scaffold\" caseless rifle"
	desc = "A old and lost gun design of a caseless rifle by Simulacrum Robotics, its high fire rate stopping power and more make it the perfect frame for war. \
	Its'caliber is 7mm caseless and shockingly can be fitted with a silencer, has room for a scope and the ablity for a Master Unmaker to be integrated into it."
	...
	auto_eject = TRUE
	matter = list(MATERIAL_INDSTEEL = 35, MATERIAL_PLASTIC = 35, MATERIAL_PLATINUM = 20)
	price_tag = 2000
