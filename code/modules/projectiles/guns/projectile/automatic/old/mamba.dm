...
/obj/item/gun/projectile/automatic/mamba/copperhead
	...
	desc = "The \"Copperhead\" rifle appears to be a design based off the Liberty Marshal's \"Mamba\" carbine, chambered in 7.62mm and sporting a carry handle the Copperhead is intended both as a squad support weapon and as a battle rifle, sporting a recoil compensating stock as well as an underbarrel grenade launcher to ensure both uses."
