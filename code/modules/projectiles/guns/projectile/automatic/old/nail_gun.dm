/obj/item/gun/projectile/automatic/nail_gun
	name = "Simulacrum Robotics \"Nail\" rifle"
	desc = "A old and lost gun design of a rifle by Simulacrum Robotics, its high fire rate stopping power and more make it the perfect tool for war. \
	...
	auto_eject = TRUE
	matter = list(MATERIAL_INDSTEEL = 30, MATERIAL_PLASTIC = 25, MATERIAL_TITANIUMRTC = 20)
	price_tag = 2000
