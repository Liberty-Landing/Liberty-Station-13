...
/obj/item/gun/projectile/automatic/chaingun
	...
	desc = "A massive single-barrel chaingun originally intended as a vehicle mounted weapon. Refitted for and commonly seen with Terran powered infantry, it's a devastating tool for removing those stubborn stains on the universe. \
	...
	damage_multiplier = 1
	slowdown = 0.15
	matter = list(MATERIAL_INDSTEEL = 50, MATERIAL_PLASTIC = 20)
	price_tag = 2500
