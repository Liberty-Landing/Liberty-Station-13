/obj/item/clothing/glasses/powered/thermal
	...
	price_tag = 500
	matter = list(MATERIAL_ALUMINIUM = 3, MATERIAL_GLASS = 2, MATERIAL_PLASTIC = 5, MATERIAL_DIAMOND = 2)
	tick_cost = 0.5
...
/obj/item/clothing/glasses/powered/thermal/onestar
	...
	matter = list(MATERIAL_ALUMINIUM = 3, MATERIAL_GLASS = 2, MATERIAL_PLASTIC = 5, MATERIAL_TITANIUM = 2) // SD tech all use platinum
