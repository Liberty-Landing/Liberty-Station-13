...
/datum/surgery_step/insert_item/begin_step(mob/living/user, obj/item/organ/external/organ, obj/item/tool)// We want to install whatever the gripper is holding, not the gripper itself
