...
/obj/item/integrated_circuit/input/matscan
	...
	spawn_flags = IC_SPAWN_RESEARCH
	power_draw_per_use = 40
	var/list/mtypes = list(MATERIAL_ALUMINIUM, MATERIAL_GLASS, MATERIAL_SILVER, MATERIAL_GOLD, MATERIAL_DIAMOND, MATERIAL_HYDROGENC, MATERIAL_URANIUM, MATERIAL_INDSTEEL, MATERIAL_TITANIUM, MATERIAL_GLASS, MATERIAL_PLASTIC)
