...
/obj/item/integrated_circuit/input/matscan
	...
	outputs = list(
		MATERIAL_ALUMINIUM				 	= IC_PINTYPE_NUMBER,
		...
		MATERIAL_HYDROGENC					= IC_PINTYPE_NUMBER,
		MATERIAL_URANIUM				= IC_PINTYPE_NUMBER,
		MATERIAL_INDSTEEL				= IC_PINTYPE_NUMBER,
		MATERIAL_TITANIUMRTC				= IC_PINTYPE_NUMBER,
		MATERIAL_GLASS					= IC_PINTYPE_NUMBER,
	...
	spawn_flags = IC_SPAWN_RESEARCH
	power_draw_per_use = 40
	var/list/mtypes = list(MATERIAL_ALUMINIUM, MATERIAL_GLASS, MATERIAL_SILVER, MATERIAL_GOLD, MATERIAL_DIAMOND, MATERIAL_HYDROGENC, MATERIAL_URANIUM, MATERIAL_INDSTEEL, MATERIAL_TITANIUMRTC, MATERIAL_GLASS, MATERIAL_PLASTIC)
