...
/datum/lecture/hearthcore/sblazelance/perform(mob/living/carbon/human/lecturer, obj/item/implant/core_implant/C)
	...
	if(rob >= 40) //You need 40 robustness at minimum to use this lecture
		...
		if(lecturer.equip_to_slot_if_possible(flame, lecturer.get_active_hand()))
			...
			addtimer(CALLBACK(lecturer, /datum/lecture/hearthcore/sblazelance/proc/warn_nuker, lecturer, flame), 3 SECONDS)
...
/datum/lecture/hearthcore/sblazelance/proc/warn_nuker(mob/lecturer, obj/flame)
/*
...
*/
	if(ishuman(flame.loc))
		...
		addtimer(CALLBACK(lecturer, /datum/lecture/hearthcore/sblazelance/proc/nukier_holder, lecturer, flame), 3 SECONDS)
	else
		playsound(usr.loc, pick('sound/effects/sparks1.ogg','sound/effects/sparks2.ogg','sound/effects/sparks3.ogg'), 50, 1, -3)
		new /obj/effect/explosion(flame.loc)
		qdel(flame)

/datum/lecture/hearthcore/sblazelance/proc/nukier_holder(mob/lecturer, obj/flame)
	if(ishuman(flame.loc))
...
/datum/lecture/hearthcore/convert_flesh
...
/datum/lecture/hearthcore/convert_flesh/perform(mob/living/carbon/human/lecturer, obj/item/implant/core_implant/C)
	C.restore_power(100)
