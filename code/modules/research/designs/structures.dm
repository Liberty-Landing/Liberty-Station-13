...
/datum/design/research/structure/bidon
	...
	category = "Medical"
	materials = list(MATERIAL_ALUMINIUM = 15, MATERIAL_GLASS = 5)
...
/datum/design/research/structure/bidonadv
	...
	category = "Medical"
	materials = list(MATERIAL_ALUMINIUM = 25, MATERIAL_GLASS = 15)
...
/datum/design/research/structure/solar
	...
	category = CAT_POWER
	materials = list(MATERIAL_ALUMINIUM = 5, MATERIAL_GLASS = 5)
