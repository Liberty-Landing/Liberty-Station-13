...
/datum/reagent/adminordrazine //An OP chemical for admins
	name = "Chemical X"
	id = "adminordrazine"
	description = "An extremely rare chemical rumored to have been created specifically by Phokorus Institute director Nakharan Mkne. Believed to be able to bring back even the dead or keep even the most \
	ruined of people away from death's door. How did you get this?"
	taste_description = "overpowered plot armor"
	reagent_state = LIQUID
	color = "#daa520"
	...
	glass_desc = "A powerful chemical cocktail that cant be reproduced without advacned tech."
