...
/obj/item/reagent_containers/food/drinks/cans/grapesoda
	name = "\"ZAP\" grape soda"
	desc = "Smells like someone dumped bunch of nanites inside."
	icon_state = "grapesoda"
	center_of_mass = list("x"=16, "y"=10)
	preloaded_reagents = list("grapesoda" = 26, "nanites" = 4)
