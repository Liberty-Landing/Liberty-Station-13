...
/obj/item/stalker_fuel_rod
	...
	matter = list(MATERIAL_ALUMINIUM = 3, MATERIAL_HYDROGENC = 5, MATERIAL_LBGLASS = 1, MATERIAL_DIAMOND = 2, MATERIAL_PLATINUM = 1)
...
/obj/item/stalker_fuel_rod/depleted
	...
	matter = list(MATERIAL_ALUMINIUM = 3, MATERIAL_LBGLASS = 1, MATERIAL_DIAMOND = 2, MATERIAL_PLATINUM = 1)
