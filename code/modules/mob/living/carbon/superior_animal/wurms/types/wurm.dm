...
/mob/living/carbon/superior_animal/wurm
	name = "wurm youngling"
	desc = "A plasma eating wurm capable of firing volatile globs of electric acid if they spot prey. Hated by Skylight miners as many do not know it is there until they are hit by acid. This one is merely a youngling and not nearly as dangerous as an adult."
