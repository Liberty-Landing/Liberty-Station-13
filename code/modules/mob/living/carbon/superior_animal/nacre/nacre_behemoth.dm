...
/mob/living/carbon/superior_animal/nacre_golem/behemoth
	name = "nacre behemoth"
	desc = "A weird creature made of nacre. It is bigger, stronger and pack a harder punch than its brethen."
	icon_state = "golem_nacre_purple"
	health = 200
	maxHealth = 200
...
/mob/living/carbon/superior_animal/nacre_golem/behemoth/attack_hand(mob/living/carbon/M as mob)
