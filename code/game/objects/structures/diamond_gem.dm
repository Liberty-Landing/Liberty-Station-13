/obj/structure/diamond
	...
	it in the Skylight vault as an insurance policy."
	...
	matter = list(MATERIAL_VOXALLOY = 5, MATERIAL_DIAMOND = 30, MATERIAL_INDSTEEL = 10, MATERIAL_TITANIUMRTC = 20, MATERIAL_HYDROGENC = 20, MATERIAL_LBGLASS = 60, MATERIAL_HYDROGENC = 100)
...
/obj/structure/diamond/wealthy_shovel
	...
	desc = "A rose gold made shovel stuck in a mount of diamonds to flaunt wealth over how Skylight was able to corner and then oversaturate the tools market."
