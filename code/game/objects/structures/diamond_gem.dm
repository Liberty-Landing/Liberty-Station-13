/obj/structure/diamond
	...
	matter = list(MATERIAL_VOXALLOY = 5, MATERIAL_DIAMOND = 30, MATERIAL_TITANIUM = 10, MATERIAL_TITANIUMRTC = 20, MATERIAL_HYDROGENC = 20, MATERIAL_LBGLASS = 60, MATERIAL_HYDROGENC = 100)
