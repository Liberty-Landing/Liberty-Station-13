/obj/structure/diamond
	...
	matter = list(MATERIAL_VOXALLOY = 5, MATERIAL_DIAMOND = 30, MATERIAL_TITANIUM = 10, MATERIAL_OSMIUM = 20, MATERIAL_MHYDROGEN = 20, MATERIAL_LBGLASS = 60, MATERIAL_HYDROGENC = 100)
