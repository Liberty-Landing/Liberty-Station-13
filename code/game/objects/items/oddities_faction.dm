...
/obj/item/biosyphon
	...
	desc = "An exceedingly rare bluespace anomaly discovered by a marshal ranger outside the colony. \
	After weeks of study it was determined its only purpose was duplicating boxes of donuts. \
	Phokorus Institute's disappointment was so great they gave the item to security for safe keeping. \
	Months after its discovery it began to create refined cases of incredibly tasty donuts filled with long-lasting effective stimulants every two hours."
...
/obj/item/device/techno_tribalism
	...
	price_tag = 20000
	var/list/oddity_stats = list(STAT_MEC = 0, STAT_COG = 0, STAT_BIO = 0, STAT_ROB = 0, STAT_TGH = 0, STAT_VIG = 0, STAT_WIL = 0, STAT_END = 0)
