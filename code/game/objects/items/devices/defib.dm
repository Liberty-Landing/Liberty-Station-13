#define DEFIB_TIME_LIMIT (20 MINUTES) //past this many seconds, defib is useless.
...
/obj/item/device/defib_kit
	...
	matter = list(MATERIAL_ALUMINIUM = 10, MATERIAL_PLASTIC = 5, MATERIAL_GLASS = 1, MATERIAL_GOLD = 3.25, MATERIAL_SILVER = 4.25) //Glass for the lights
...
/obj/item/device/defib_kit/compact
	...
	matter = list(MATERIAL_ALUMINIUM = 5, MATERIAL_PLASTIC = 7, MATERIAL_GLASS = 2, MATERIAL_GOLD = 7.75, MATERIAL_SILVER = 12.75) //Glass for the lights
