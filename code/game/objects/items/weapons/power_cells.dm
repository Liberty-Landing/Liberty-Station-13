...
/obj/item/cell/large
	...
	icon_state = "b_st"
	maxcharge = 1000
	matter = list(MATERIAL_DURALUMIN = 3, MATERIAL_COPPER = 3, MATERIAL_SILVER = 3)
...
/obj/item/cell/large/copper
	name = "Fusioncore \"Electrasphere 20000L\"
	desc = "Fusioncore branded non-rechargeable L-standardized power cell. A rare, and likely found in the trash, batteries made of copper coils from a now bankrupt Terran industry."
	icon_state = "b_nt"
	matter = list(MATERIAL_COPPER = 2, MATERIAL_DURALUMIN = 4)
	maxcharge = 13000
	max_chargerate = 0
	created_max_charge = TRUE

/obj/item/cell/large/copper/superior
	name = "Fusioncore \"Photonmatrix 20000L\"
	desc = "Fusioncore branded non-rechargeable L-standardized power cell. A rare, and likely found in the trash, batteries made of copper coils from a now bankrupt Terran industry."
	icon_state = "b_nt_pl"
	matter = list(MATERIAL_COPPER = 3, MATERIAL_DURALUMIN = 4, MATERIAL_SILVER = 1)
	maxcharge = 20000

/obj/item/cell/large/copper/advanced
	name = "Fusioncore \"Hyperflux 26000L\""
	desc = "Fusioncore branded non-rechargeable L-standardized power cell. A rare, and likely found in the trash, batteries made of copper coils from a now bankrupt Terran industry."
	icon_state = "b_nt_pl"
	matter = list(MATERIAL_COPPER = 5, MATERIAL_DURALUMIN = 6, MATERIAL_SILVER = 2)
	maxcharge = 26000
...
/obj/item/cell/large/moebius/omega
	...
	matter = list(MATERIAL_DURALUMIN = 3, MATERIAL_COPPER = 3, MATERIAL_SILVER = 3, MATERIAL_GOLD = 6)
...
/obj/item/cell/large/moebius/nuclear
	...
	autorecharging = TRUE
	origin_tech = list(TECH_POWER = 6)
	matter = list(MATERIAL_DURALUMIN = 3, MATERIAL_COPPER = 3, MATERIAL_SILVER = 3, MATERIAL_URANIUM = 6)
...
/obj/item/cell/large/excelsior
	...
	matter = list(MATERIAL_DURALUMIN = 4, MATERIAL_COPPER = 2)
	maxcharge = 18000
...
/obj/item/cell/medium
	...
	throw_range = 7
	maxcharge = 600
	matter = list(MATERIAL_DURALUMIN = 2, MATERIAL_COPPER = 2, MATERIAL_SILVER = 2)
...
/obj/item/cell/medium/moebius/omega
	...
	matter = list(MATERIAL_DURALUMIN = 2, MATERIAL_COPPER = 2, MATERIAL_SILVER = 2, MATERIAL_GOLD = 4)
...
/obj/item/cell/medium/moebius/nuclear
	...
	icon_state = "meb_m_nu"
	autorecharging = TRUE
	matter = list(MATERIAL_DURALUMIN = 2, MATERIAL_COPPER = 2, MATERIAL_SILVER = 2, MATERIAL_URANIUM = 4)
...
/obj/item/cell/small
	...
	throw_range = 7
	maxcharge = 100
	matter = list(MATERIAL_DURALUMIN = 1, MATERIAL_COPPER = 1, MATERIAL_SILVER = 1)
...
/obj/item/cell/small/moebius/omega
	...
	matter = list(MATERIAL_DURALUMIN = 1, MATERIAL_COPPER = 1, MATERIAL_SILVER = 1, MATERIAL_GOLD = 2)
...
/obj/item/cell/small/moebius/nuclear
	...
	autorecharging = TRUE
	origin_tech = list(TECH_POWER = 6)
	matter = list(MATERIAL_DURALUMIN = 1, MATERIAL_COPPER = 1, MATERIAL_SILVER = 1, MATERIAL_URANIUM = 2)
	preloaded_reagents = list("radium" = 5)
	maxcharge = 300
	price_tag = 100
...
/obj/item/cell/small/moebius/pda
	...
	matter = list(MATERIAL_DURALUMIN = 1, MATERIAL_COPPER = 1, MATERIAL_URANIUM = 1)
	preloaded_reagents = list("radium" = 5)
	maxcharge = 50
...
/obj/item/device/manual_charger
	...
	matter = list(MATERIAL_DURALUMIN = 30)
	cell = null
