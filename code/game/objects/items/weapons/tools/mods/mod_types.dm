...
/obj/item/tool_upgrade/augment/holding_tank
	...
	matter = list(MATERIAL_PLASTIC = 2, MATERIAL_INDSTEEL = 4, MATERIAL_TITANIUMRTC = 4)
	price_tag = 250
...
/obj/item/tool_upgrade/augment/sanctifier
	...
	matter = list(MATERIAL_CARBON_FIBER = 3, MATERIAL_SILVER = 5)
	price_tag = 20
...
/obj/item/tool_upgrade/augment/dampener
	...
	icon_state = "dampener"
	matter = list(MATERIAL_PLASTIC = 1, MATERIAL_INDSTEEL = 1, MATERIAL_TITANIUMRTC = 1)
...
/obj/item/tool_upgrade/augment/ai_tool
	...
	icon_state = "ai_tool"
	matter = list(MATERIAL_PLASTIC = 1, MATERIAL_INDSTEEL = 3, MATERIAL_TITANIUMRTC = 3, MATERIAL_GOLD = 3, MATERIAL_DIAMOND = 1)
	price_tag = 725
	can_remove = FALSE
