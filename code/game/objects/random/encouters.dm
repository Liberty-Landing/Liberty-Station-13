...
/obj/random/encouter
	...
	var/list/obj/random/spawner/encouter/encouters = list(/obj/random/spawner/encouter/mine, /obj/random/spawner/encouter/strangebeacon, \
...
/obj/random/spawner/encouter/strangebeacon
	randspawn = list(/obj/structure/strangebeacon, /obj/structure/strangebeacon/pods, \
