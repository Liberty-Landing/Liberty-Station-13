...
/obj/random/mob/golem/item_to_spawn()
	return pickweight(list(/mob/living/carbon/superior_animal/nacre_golem = 24,
				/mob/living/carbon/superior_animal/nacre_golem/runtling = 32,
				/mob/living/carbon/superior_animal/nacre_golem/nacre_shooter = 16,
				/mob/living/carbon/superior_animal/nacre_golem/behemoth = 1 //1 in 73 so should be rare...
				))
