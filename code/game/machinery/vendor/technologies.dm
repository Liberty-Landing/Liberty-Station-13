...
/obj/machinery/vending/build_a_drone
	...
	auto_price = TRUE
	vendor_department = DEPARTMENT_SCIENCE // Phokorus Institute get paid for the drones

/obj/item/build_a_drone_kit
	name = "build-a-drone kit"
	desc = "A self-assembling Build-A-Drone kit designed by Phokorus Institute's Robotic Division. No refunds."
