...
/obj/machinery/autolathe/artist_bench
	...
	desc = "Insert carbon fiber, aluminium, glass, indsteel, plastic and a bit of your soul to create a beautiful work of art."
	...
	suitable_materials = list(MATERIAL_CARBON_FIBER, MATERIAL_ALUMINIUM, MATERIAL_GLASS, MATERIAL_INDSTEEL, MATERIAL_PLASTIC)
	var/min_mat = 20
	var/min_insight = 40
