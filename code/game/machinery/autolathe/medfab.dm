/obj/machinery/autolathe/medfab
	...
	suitable_materials = list(MATERIAL_CLOTH, MATERIAL_WOOD, MATERIAL_ALUMINIUM, MATERIAL_GLASS, MATERIAL_PLASTIC, MATERIAL_INDSTEEL, MATERIAL_SILVER, MATERIAL_BIOMATTER, MATERIAL_TITANIUM, MATERIAL_COMPOSITE, MATERIAL_TITANIUMRTC, MATERIAL_COPPER)
