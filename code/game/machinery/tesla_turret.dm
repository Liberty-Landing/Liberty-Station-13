...
/obj/machinery/tesla_turret
	...
	desc = "An experimental Tesla Coil Turret for point-defense and pest control, developed as Phokorus Institute's answer to the Bonfire's Obelisks. Bears a Blue-Ink Logo on its central Pylon."
	anchored = TRUE
	density = TRUE
				...
				if(stat & BROKEN)
					...
					if(do_after(user, 20, src))
						if(prob(70))
							...
							new /obj/item/stack/material/aluminium(loc, rand(1,8))
