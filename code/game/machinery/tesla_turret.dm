...
/obj/machinery/tesla_turret
	...
	desc = "An experimental Tesla Coil Turret for point-defense and pest control, developed as Phokorus Institute's answer to the Absolute's Obelisks. Bears a Blue-Ink Logo on its central Pylon."
	anchored = TRUE
	density = TRUE
