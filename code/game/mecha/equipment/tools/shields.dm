/obj/item/mecha_parts/mecha_equipment/combat_shield
	...
	matter = list(MATERIAL_INDSTEEL = 12, MATERIAL_GOLD = 6, MATERIAL_SILVER = 6, MATERIAL_URANIUM = 4, MATERIAL_TITANIUM = 4, MATERIAL_DIAMOND = 2)
	equip_cooldown = 5
	energy_drain = 20
	range = 0
	price_tag = 2000
...
/obj/item/shield_projector
	...
	matter = list(MATERIAL_INDSTEEL = 6, MATERIAL_GOLD = 3, MATERIAL_SILVER = 3, MATERIAL_URANIUM = 2, MATERIAL_TITANIUM = 2, MATERIAL_DIAMOND = 1)
