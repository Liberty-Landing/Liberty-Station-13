...
/datum/construction/mecha/gygax_chassis
	steps = list(
		list("key"=/obj/item/mecha_parts/part/gygax_torso, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil."),//1
		list("key"=/obj/item/mecha_parts/part/gygax_left_arm, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil."),//2
		list("key"=/obj/item/mecha_parts/part/gygax_right_arm, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil."),//3
		list("key"=/obj/item/mecha_parts/part/gygax_left_leg, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil."),//4
		list("key"=/obj/item/mecha_parts/part/gygax_right_leg, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil."),//5
		list("key"=/obj/item/mecha_parts/part/gygax_head, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil."),//6
		list("key"=/obj/item/tool_upgrade/productivity/antistaining, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil."),//7 the idea is that its like an oil for its movement
		list("key"=/obj/item/stock_parts/smes_coil, desc = "The chassis for a Gygax mech. Needs a Gygax head, torso, arms and legs, as well as anti-staining paint and a SMES coil.")//8 Lots of power and connections to legs
	)
