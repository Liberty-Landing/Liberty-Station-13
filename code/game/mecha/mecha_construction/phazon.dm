...
/datum/construction/mecha/phazon_chassis
	steps = list(
		list("key"=/obj/item/mecha_parts/part/phazon_torso, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."),//1
		list("key"=/obj/item/mecha_parts/part/phazon_left_arm, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."),//2
		list("key"=/obj/item/mecha_parts/part/phazon_right_arm, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."),//3
		list("key"=/obj/item/mecha_parts/part/phazon_left_leg, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."),//4
		list("key"=/obj/item/mecha_parts/part/phazon_right_leg, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."),//5
		list("key"=/obj/item/mecha_parts/part/phazon_head, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."), //6,
		list("key"=/obj/item/bluespace_crystal/artificial, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."), //7,
		list("key"=/obj/item/stock_parts/smes_coil/super_capacity, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."), //8,
		list("key"=/obj/item/gun_upgrade/mechanism/overdrive, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil."), //9,
		list("key"=/obj/item/cell/large/moebius/nuclear, desc = "The chassis for a Phazon mech. Needs a Phazon head, torso, arms and legs, as well as an artificial bluespace crystal, \"Tesla\" overdrive chip, large atomic cell, and a super capacity SMES coil.") //10
	)
