...
/datum/construction/mecha/firefighter_chassis
	steps = list(
		list("key"=/obj/item/mecha_parts/part/ripley_torso, desc = "A chassis for a Firefighter mech. Needs a Ripley torso, arms and legs, as well as a fire suit."),//1
		list("key"=/obj/item/mecha_parts/part/ripley_left_arm, desc = "A chassis for a Firefighter mech. Needs a Ripley torso, arms and legs, as well as a fire suit."),//2
		list("key"=/obj/item/mecha_parts/part/ripley_right_arm, desc = "A chassis for a Firefighter mech. Needs a Ripley torso, arms and legs, as well as a fire suit."),//3
		list("key"=/obj/item/mecha_parts/part/ripley_left_leg, desc = "A chassis for a Firefighter mech. Needs a Ripley torso, arms and legs, as well as a fire suit."),//4
		list("key"=/obj/item/mecha_parts/part/ripley_right_leg, desc = "A chassis for a Firefighter mech. Needs a Ripley torso, arms and legs, as well as a fire suit."),//5
		list("key"=/obj/item/clothing/suit/fire, desc = "A chassis for a Firefighter mech. Needs a Ripley torso, arms and legs, as well as a fire suit.")//6
	)
