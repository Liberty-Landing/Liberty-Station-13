...
/datum/category_item/setup_option/core_implant/cruciform
	...
	restricted_to_species = list(FORM_HUMAN, FORM_SABLEKYNE, FORM_KRIOSAN, FORM_AKULA, FORM_MARQUA, FORM_NARAMAD, FORM_CINDAR)
/*
...
/datum/category_item/setup_option/core_implant/cruciform/tessellate
	...
	desc = "The implant given to every disciple of the Bonfire. This one is made for those who walk the path of the Tessellate, disciples who promote unity and healing, it charges slightly faster \
...
/datum/category_item/setup_option/core_implant/cruciform/lemniscate
	...
	desc = "The implant given to every disciple of the Bonfire. This one is made for those who walk the path of the Lemniscate, disciples who promote the idea that change is itself circular in \
...
/datum/category_item/setup_option/core_implant/cruciform/monomial
	...
	desc = "The implant given to every disciple of the Bonfire. This one is made for those who walk the path of the Monomial, disciples who promote personal improvement and aesthetic living, \
...
/datum/category_item/setup_option/core_implant/cruciform/divisor
	...
	desc = "The implant given to every disciple of the Bonfire. This one is made for those who walk the path of the Divisor, disciples who promote security of the church and its members, \
	those who walk this path desire to protect the flock through arms, functioning as an internal guard to the Bonfire."
...
/datum/category_item/setup_option/core_implant/cruciform/factorial
	...
	desc = "The implant given to every disciple of the Bonfire. This one is made for those who walk the path of the Factorial, disciples who apprentice themselves to the machines and technology \
