...
/datum/design/autolathe/tool/multitool/multitool_onestar
	...
	materials = list(MATERIAL_INDSTEEL = 1, MATERIAL_PLATINUM = 2)
...
/datum/design/autolathe/tool/weldertool_onestar
	...
	materials = list(MATERIAL_INDSTEEL = 3, MATERIAL_PLATINUM = 1)
...
/datum/design/autolathe/tool/combi_driver
	...
	materials = list(MATERIAL_INDSTEEL = 2)
...
/datum/design/autolathe/tool/hammer_onestar
	...
	materials = list(MATERIAL_INDSTEEL = 6, MATERIAL_PLATINUM = 2)
...
/datum/design/autolathe/tool/omni_surgery_onestar
	...
	materials = list(MATERIAL_INDSTEEL = 2, MATERIAL_PLATINUM = 1)
