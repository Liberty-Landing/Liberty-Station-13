...
/datum/design/autolathe/ammo/shotgun
	...
	materials = list(MATERIAL_ALUMINIUM = 5)
...
/datum/design/autolathe/ammo/shotgun_box
	...
	materials = list(MATERIAL_ALUMINIUM = 6)
...
/datum/design/autolathe/ammo/shotgun_illumination
	...
	materials = list(MATERIAL_ALUMINIUM = 6, MATERIAL_SILVER = 2)
...
/datum/design/autolathe/ammo/shotgun_plasma
	...
	materials = list(MATERIAL_ALUMINIUM = 6, MATERIAL_SILVER = 1, MATERIAL_GOLD = 1, MATERIAL_URANIUM = 1)
...
/datum/design/autolathe/ammo/shotgun_plasma_heavy
	...
	materials = list(MATERIAL_ALUMINIUM = 6, MATERIAL_SILVER = 2, MATERIAL_GOLD = 2, MATERIAL_URANIUM = 2)
...
/datum/design/autolathe/ammo/shotgun_speedloader_slug
	...
	materials = list(MATERIAL_ALUMINIUM = 8)
...
/datum/design/autolathe/ammo/sbaw_slug
	...
	materials = list(MATERIAL_ALUMINIUM = 10)
...
/datum/design/autolathe/ammo/pistol
	...
	materials = list(MATERIAL_ALUMINIUM = 1)
...
/datum/design/autolathe/ammo/hpistol
	...
	materials = list(MATERIAL_ALUMINIUM = 2)
...
/datum/design/autolathe/ammo/pistol_35_drum
	...
	materials = list(MATERIAL_ALUMINIUM = 18)
...
/datum/design/autolathe/ammo/pistol_ammobox/large
	...
	materials = list(MATERIAL_ALUMINIUM = 12)
...
/datum/design/autolathe/ammo/magnum_pepperball
	...
	materials = list(MATERIAL_ALUMINIUM = 3, MATERIAL_PLASTIC = 2)
...
/datum/design/autolathe/ammo/magnum_ammobox
	...
	materials = list(MATERIAL_ALUMINIUM = 9)
...
/datum/design/autolathe/ammo/lrifle_ammobox
	...
	materials = list(MATERIAL_ALUMINIUM = 20)
...
/datum/design/autolathe/ammo/lrifle_belt
	...
	materials = list(MATERIAL_ALUMINIUM = 7)
...
/datum/design/autolathe/ammo/lrifle_speed_loader
	...
	materials = list(MATERIAL_ALUMINIUM = 0.1)
...
/datum/design/autolathe/ammo/clbox_7mm
	...
	materials = list(MATERIAL_ALUMINIUM = 25)
...
/datum/design/autolathe/ammo/box_antim
	...
	materials = list(MATERIAL_ALUMINIUM = 30, MATERIAL_INDSTEEL = 30)

/datum/design/autolathe/ammo/antim
	name = "loose shells (14.5×114mm)"
	build_path = /obj/item/ammo_casing/antim/prespawned
	materials = list(MATERIAL_ALUMINIUM = 5, MATERIAL_INDSTEEL = 5)
