...
/decl/security_level/default/code_green
	...
	down_description = "All threats to the colony have passed. Members of the Vanguard Branch may not have weapons visible, privacy laws are once again fully enforced."
...
/decl/security_level/default/code_blue
	...
	up_description = "The colony has received reliable information about possible hostile activity in the colony. Vanguard branch staff may have weapons visible, random searches are permitted."
	down_description = "The immediate threat has passed. Vanguard branch may no longer have weapons drawn at all times, but may continue to have them visible. Random searches are still allowed."
...
/decl/security_level/default/code_red
	...
	up_description = "There is an immediate serious threat to the colony. Vanguard branch may have weapons unholstered at all times. Random searches are allowed and advised. The Watch is taking complete leadership of the Vanguard Branch."
	down_description = "The alarming destruction of the colony has been disproven. There is still however an immediate serious threat to the colony. Vanguard branch may have weapons unholstered at all times, random searches are allowed and advised."
